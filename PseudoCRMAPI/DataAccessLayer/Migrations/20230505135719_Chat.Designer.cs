...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.ChatEntities.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.ChatEntities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Organization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.ChatEntities.Message", b =>
                {
                    b.HasOne("Core.ChatEntities.Chat", "Chat")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Core.Organization", b =>
                {
                    b.HasOne("Core.ChatEntities.Chat", "Chat")
                        ...
                        .HasForeignKey("Core.Organization", "ChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.User", b =>
                {
                    b.HasOne("Core.Organization", "Organization")
                        .WithMany("Users")
